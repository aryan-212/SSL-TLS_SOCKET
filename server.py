...
version_dict = {
    ...
    "sslv23": ssl.PROTOCOL_SSLv23,  # Replace ssl.PROTOCOL_SSLv3 with ssl.PROTOCOL_SSLv23
}
...
while True:
    ...
    try:
        ...
        with open(filename[1:].decode(), 'rb') as f:
            outputdata = f.read()

        # Send one HTTP header line into socket
        # reference website: https://goo.gl/UGTC9Q
        response_headers = {
